...
-- Table: public.outline_media_comments

-- DROP TABLE IF EXISTS public.outline_media_comments;

CREATE TABLE IF NOT EXISTS public.outline_media_comments
(
    id bigint NOT NULL,
...
ALTER TABLE IF EXISTS public.outline_media_comments
    OWNER to postgres;

-- Table: public.outline_medias

-- DROP TABLE IF EXISTS public.outline_medias;

CREATE TABLE IF NOT EXISTS public.outline_medias
(
    id bigint NOT NULL,
...
ALTER TABLE IF EXISTS public.outline_medias
    OWNER to postgres;

-- Table: public.outlines
...
ALTER TABLE IF EXISTS public.outlines
    OWNER to postgres;
